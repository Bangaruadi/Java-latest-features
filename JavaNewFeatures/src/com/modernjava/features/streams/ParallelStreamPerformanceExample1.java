...
public class ParallelStreamPerformanceExample1 {
    static long tokenCount = 50000;
    public static void main(String[] args) {
        int loop=20;
        long result = measurePerformance(ParallelStreamPerformanceExample1
                ::sortSequentialStream, loop);
        System.out.println("Time taken to process sort in sequential: " + result + " msecs");
        result = measurePerformance(ParallelStreamPerformanceExample1::sortParallelStream, loop);
